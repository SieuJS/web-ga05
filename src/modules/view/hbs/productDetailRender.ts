...
export function productDetailRender (product : ProductData) {
    console.log("Get in productDetailRender")
    return `
    <div class="single_product_desc">
                            ...
                            <p class="available">Available: ${product.quantity}<span class="text-muted">In Stock</span></p>
                            ...
                            <form class="cart clearfix mb-50 d-flex" method="post">
                                ...
                                <button type="submit" name="addtocart" value="5" class="btn cart-submit cart-submit-event d-block" >Add to cart</button>
                            </form>
...
export function productImageRender (product : ProductData) {
    return `
